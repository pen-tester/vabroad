<%@ Page Language="C#" MasterPageFile="~/MasterPageNoCss.master" AutoEventWireup="true" CodeFile="MakePayment2.aspx.cs" Inherits="MakePayment" Title="Make Payment" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" Runat="Server">
    ...
    select the button below. If you find PayPal difficult to use; we can process your
    credit card another way. We will contact you by telephone. If you wish to call us
    with your credit card, please call. <b>We only accept Visa, MasterCard, or Diners Club</b><br />
	<br />

...
<table width='600px'>
  ...
  <tr>
     <td colspan='2' width='600px'>
       <div style='width: 100%;text-align: center;'>
         <img alt='Vacation Abroad' title='Vacation Abroad' width='300px' height='180px' src='https://www.vacations-abroad.com/images/elogo.jpg'>
       </div>
     </td>
  </tr>
</table>
 ...
 ";
                ...
                BookDBProvider.SendEmail(ownerinfo.email,String.Format("{0} {1},Reservation for {2} {3}",  ownerinfo.firstname,ownerinfo.lastname, arrivedate,propinfo.FileName) , msg);

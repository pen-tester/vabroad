...
<asp:Content ID="link" ContentPlaceHolderID="links" runat="server">
    <style>
        ...
        .contestbox{margin:10px auto;width:80%;text-align:left;}.contestfooter a,.contestfooter a:hover{text-decoration:none;color:#ff7d26;}
          ...
          .checkbox-custom, .radio-custom {
            ...
            .shareicon{ display:inline-block;border:solid 1px #ff7d26; min-width:25px;min-height:25px;font-size:16px;color:#ff7d26;} .shareicon:hover{cursor:pointer;}
            .glenn {

...
<form id="mainform" runat="server">
                  ...
                  <div class="center">
                        <ul class="stateful">
                            ...
                            <li> 
                                ...
                                <a href="<%=href %>">
                                    <div class='drop-shadow effect4'><img width='160' height='125' src="<%=String.Format("/images/{0}", row["FileName"]).ToLower() %>" alt="<%=String.Format("{0} properties",row["StateProvince"]) %>" title="<%=String.Format("{0} properties",row["StateProvince"]) %>" /></div>
                                </a>
                            </li>
                            <%} %>
                        </ul>
    ...
    <script type="text/javascript" defer="defer" src="/assets/js/countryproperty.js?6">
    </script>

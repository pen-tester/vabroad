...
<asp:Content ID="links" ContentPlaceHolderID="links" runat="server">
 ...
 <link id="jscss" rel="stylesheet"  href="/css/jcarousel.css" />
  <style>
      ...
      .textfont{color:#3c3c3c;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;}.dotstyle{font-size:16px;font-weight:bold;color:cornflowerblue;}.amenitybackground{background-color:#f3ede3;} .amenitybackground li{display:inline;  color:black;  padding:4px 5px;} .amenitybackground ul{color:#154890;list-style-type:disc;}
  </style>
</asp:Content>

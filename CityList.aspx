...
<asp:Content ID="head" ContentPlaceHolderID="head" runat="server">
    <%=countryinfo.City %> Vacation Rentals, Boutique Hotels | Vacations Abroad
</asp:Content>
                ...
                <div class="page_hid" id="cpage<%=pg %>">
                    ...
                    <%  //Loop for each property
                        ...
                        for (int i = pg*10; i < maxitem; i++)
                        {
                            ...
                            if (proptypeinfo.Contains(propamen.detail.CategoryID)) alt = String.Format("{0} {1} BD Boutique Hotel", propamen.detail.City, propamen.detail.NumBedrooms);
                            else alt =  String.Format("{0} {1} BD Vacation Rental", propamen.detail.City, propamen.detail.NumBedrooms);;
                            //alt = String.Format("{0} {1} vacations", propamen.detail.City, propamen.detail.StateProvince);

                ...
                <td colspan="100" class="StateTable1TD1">
                    <div class="Left" style="margin: 8px;">
                        ...
                        <div class="addthis_toolbox addthis_default_style" width="100%">
                            <a href="http://addthis.com/bookmark.php?v=250&amp;pub=natasha499" class="addthis_button_compact">
                ...
                <td class="StateTable1TD2">
                    ...
                    <div style="width: 100%">
                        <div style="float: right; width: 21%;">
                            <div class="rtOuterCnty">
                                <div class="rtHeader" id="rtCounties" runat="server">
                                </div>
                            ...
                            <br />
                            <div class="rtOuterCnty">
                                <div class="rtHeader" id="rtLowerHd" runat="server">
                                </div>
                                <div id="rtLower" runat="server" class="rtText">
                                </div>
                            </div>
                        </div>
                        <div class="lftPropertiesTour">
                                ...
                                <tr>
                                    <td valign="bottom" width="20%" style="background-color: #ede9ed; border: solid 1px #999999;
                                        ...
                                        <div id="divTab1" runat="server" align="center" class="tourTabs2" width="100%">
                                            <a href='<%= CommonFunctions.PrepareURL (country.Replace (" ", "_").ToLower () + "/" + stateprovince.Replace (" ", "_").ToLower () + "/" + city.Replace(" ", "_").ToLower() + "/default.aspx") %>'>
                                                Vacation Rentals </a>
                                        </div>
                                    </td>
                                    ...
                                    <td valign="bottom" width="20%" style="background-color: #ede9ed; border: solid 1px #999999;
                                        ...
                                        <div id="div1" runat="server" align="center" class="tourTabs2" width="100%">
                                           <a href='<%# CommonFunctions.PrepareURL (country.Replace (" ", "_").ToLower () + "/" + stateprovince.Replace (" ", "_").ToLower () + "/add_" + city.Replace(" ", "_").ToLower() + "_tour/default.aspx") %>'>Add Tour </a>
                                        </div>
                                    </td>
                                    <td valign="bottom" width="20%" style="background-color: #ede9ed; border: solid 1px #999999;
                                        padding: 3px 3px 3px 3px;">
                                        <div id="div2" runat="server" align="center" class="tourTabs2" width="100%">
                                           <a href='<%# CommonFunctions.PrepareURL (country.Replace (" ", "_").ToLower () + "/" + stateprovince.Replace (" ", "_").ToLower () + "/add_" + city.Replace(" ", "_").ToLower() + "_property/default.aspx") %>'>Add Property </a>
                                    ...
                                    <td width="100%" colspan="5" style="border-bottom: solid 1px #999999; border-left: solid 1px #999999;
                                        ...
                                        <div style="float: left; width: 100%">
                                            <asp:GridView ID="State_datagrid" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                                ...
                                                <RowStyle CssClass="StateRow" />
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <table style="border-top: solid 3px #ede9ed; background-color: White;">
                                                                <tr>
                                                                    <td valign="top" style="vertical-align:top;text-align: center; width: 110px" rowspan="2">
                                                                        <%--<a href="<%# CommonFunctions.PrepareURL (((string)DataBinder.Eval(Container.DataItem, "Country", "{0}")).Replace (" ", "_").ToLower () + "/" + ((string)DataBinder.Eval(Container.DataItem, "StateProvince", "{0}")).Replace (" ", "_").ToLower () + "/" + ((string)DataBinder.Eval(Container.DataItem, "City", "{0}")).Replace (" ", "_").ToLower () + "_tours/" + DataBinder.Eval(Container.DataItem, "ID", "{0}") + "/default.aspx") %>">--%>
                                                                            <img src='<%# DataBinder.Eval(Container.DataItem, "PhotoImage", "http://www.vacations-abroad.com/images/{0}") %>'
                                                                                class="grdImg" width="110" height="90" border="1" alt="" />
                                                                       <%-- </a> --%>
                                                                        <asp:Label ID="lblPicName" CssClass="picStyle" runat="server"></asp:Label>
                                                                    </td>
                                                                    <%--start of edit--%>
                                                                    <td valign="top" style="text-align: left; width: 100%;">
                                                                        <div style="height: 105px; float: left; width: 100%" class="propLink">
                                                                            <table width="100%" class="propLink">
                                                                                <tr>
                                                                                    <td style="width: 100%;" valign="top">
                                                                                        ...
                                                                                        <br />
                                                                                        <asp:Label ID="lblDescBrief" runat="server" Text='<%# Eval("Name2","{0} ")  %>'></asp:Label>
											<br/><br/><a href="<%# Eval("sitelink")%>" target="_blank"><%# Eval("sitelink")%></a>                                                                                        
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <%--middle of edit--%>
                                                                        </div>
                                                                        <%--<div style="float: right;" class="rtRates">
                                                                            <center>
                                                                                <asp:Label ID="lblPNRates" runat="server"></asp:Label><br />
                                                                            </center>
                                                                        </div>--%>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <EmptyDataTemplate>
                                                    ...
                                                    <br />
                                                    <center>
                                                        <div style="width: 80%; text-align: left; font-size: 15px;">
                                                            We do not have any <%# city %> tours available for this city.
                                                            <br />
                                                            <br />
                                                            Are you a local tour operator in
                                                            <%# city %>,
                                                            <%# stateprovince %>?
                                                            <br />
                                                            <br />
                                                            <a href='<%# CommonFunctions.PrepareURL("TourTerms.aspx") %>'>If you are, click here
                                                                to advertise your <%# city %> tour free.</a> <br />
Advertise your <%# city %> sightseeing tour, <%# city %> escorted tour, <%# city %> private tour.
                                                        </div>
                                                    </center>
                                                    <br />
                                                    <br />
        ...
        <%= stateprovince %>
        vacation from our directory of
        <%= stateprovince %>
        rentals<br />
        <br />
        ...
        <noscript>
            <div class="statcounter">
                <a title="web counter" href="http://www.statcounter.com/free_hit_counter.html" target="_blank">
                    <img class="statcounter" src="http://c37.statcounter.com/3345780/0/c7e8957f/1/" alt="web counter"></a></div>
        </noscript>

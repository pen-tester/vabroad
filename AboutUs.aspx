...
<asp:Content ID="links" ContentPlaceHolderID="links" runat="server">
    ...
    .background{position:relative;} .back_img{width:100%;}.backitem{position:absolute;margin:0;padding:0;left:0;top:0;width:100%;}
      ...
      .formgroup{margin-top:60px;} .footeritem{margin:30px 180px 0px 0px; width:400px; background-color:#f5ede3;border:2px solid #cdbfac;padding:5px; color:#5a5a5a;text-align:left;}

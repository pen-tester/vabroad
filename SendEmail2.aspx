<%@ Page Language="C#" MasterPageFile="~/MasterPageNoCss.master" AutoEventWireup="true"
    CodeFile="~/SendEmail2.aspx.cs" Inherits="SendEmail" Title="<%# GetTitle () %>"
...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="Server">
    <div style="font-family: Arial; font-size: 13px;">
        ...
        <%-- <div class="SndEmlFont">
                                ...
                                <center>
        <table class="SndEmlTable2" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="10" style="background-color:White; height:100%; width:280px;" valign="middle">
                    <% if (PhotosSet.Tables["PropertyPhotos"].Rows.Count > 0)
                       { %>
                    <img alt='<%# PropertiesFullSet.Tables["Properties"].Rows[0]["city"] %> <%# PropertiesFullSet.Tables["Properties"].Rows[0]["type"] %>'
                        src='<%# ConfigurationManager.AppSettings["ImagesVirtualLocation"] + ((PhotosSet.Tables["PropertyPhotos"].Rows.Count > 0) ? PhotosSet.Tables["PropertyPhotos"].Rows[0]["FileName"] : "") %>'
                ...
                <%--</tr>
                        <tr>--%>
                <td class="SndEmlRed" colspan="2">
                    Please mention "<%= CommonFunctions.GetSiteName () %>" when contacting owner.
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-left:5px">
                    <b>Primary Phone:</b>
                    <%# PropertiesFullSet.Tables["Properties"].Rows[0]["PrimaryTelephone"] %>
                </td>
                <td rowspan="5" style="width: 15%; padding-right:3px; font-size:11px;">
                    Each month we will randomly select on email inquiry to receive $100.00 cash.
                    <br />
                    So if you are interested in this property, send the owner an inquiry.
                    <br />
                    We will not place you on any mailing list.
                </td>
            </tr>
            <tr>
                <td style="padding-left:5px">
            ...
            <tr>
                <td style="padding-left:5px">
                    <b>Owner Virtual Tour:</b> <a href='<%# PropertiesFullSet.Tables["Properties"].Rows[0]["VirtualTour"] %>'
                        target="_blank">
            ...
            <tr>
                <td style="padding-left:5px">
                    <b>Owner Website:</b> <a href='<%# PropertiesFullSet.Tables["Properties"].Rows[0]["Website"] %>'
                        target="_blank">
            ...
            <tr>
                ...
                <td rowspan="6" style="width: 15%; padding-right:3px; font-size:11px;">
                    Each month we will randomly select on email inquiry to receive $100.00 cash.
                    <br />
                    <br />
                    So if you are interested in this property, send the owner an inquiry.

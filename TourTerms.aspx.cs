...
public partial class TourTerms : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (chkAgree.Checked == false)
            lblInfo.Text = "Cannot create tour.  Terms not checked.";
        else
        {
    ...
    {
        string vValue = "Add a " + city + " tour to our " + city + " tour directory: Vacations-Abroad.com a " + city + " Vacation Rental Directory.";
        return vValue;
    }
}

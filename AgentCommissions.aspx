<%@ Page Language="C#" MasterPageFile="~/MasterPageNoCss.master" AutoEventWireup="true" CodeFile="AgentCommissions.aspx.cs" Inherits="AgentCommissions" Title="My Commissions" %>
	...
	<asp:Repeater ID="Repeater1" runat="server" DataMember="Commissions" DataSource="<%# MainDataSet %>">
		...
		<ItemTemplate>
			<tr>
				...
				<td align="center">
					<%# DataBinder.Eval (Container.DataItem, "PaidAmount", "{0:c}")%>
				</td>
			</tr>
		</ItemTemplate>
		<FooterTemplate>

...
string vSubSend = "";
        ...
        else
        {
            ...
            emailtoowner = "Dear " + (string)PropertiesFullSet.Tables["Properties"].Rows[0]["FirstName"] + "!<br /><br />" +
                "<font color=\"red\">Your listing has expired on Vacations-Abroad.com.  " +
                " Our current rate for advertising on our website is: 1 year for $" +
                System.Configuration.ConfigurationManager.AppSettings["AnnualListingFee"].ToString() + " USD.</font><br />" +
        ...
        emailtoowner = emailtoowner + "<br/><span style=\"font-size:12px\">Linda K. Jenkins</span><br/><span style=\"font-size:10px\">CEO Vacations-Abroad.com<br/>Atlanta, GA<br/>770-687-6889</span> <br/><img align=\"middle\" style=\"height:202px;width:223px;border-width:0px;left:34px\" src=\"http://www.vacations-abroad.com/largelogo.jpg\"/>"+
        "<span style=\"font-style:italic\">Where you can find unique vacation rentals, boutique hotels, and quaint B&Bs.</span>";
    ...
    {
        string titlereplacement = PropertiesFullSet.Tables["Properties"].Rows[0]["City"].ToString() + " Property " + propertyid.ToString() + " Holiday villas and Holiday apartments for rent";
